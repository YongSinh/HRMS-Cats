...
COPY ./target/payroll-service-0.0.1-SNAPSHOT.jar /app
...
ENTRYPOINT ["java", "-jar", "payroll-service-0.0.1-SNAPSHOT.jar", "--spring.config.location=/app/application-docker.properties" ]
